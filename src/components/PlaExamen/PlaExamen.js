 ...
 */
  ...
  /*
   useEffect(() => {
     ...
     // Aquí puedes establecer los días en el estado de tu componente o realizar otras acciones
   }, [fechaSeleccionada]);
   */
  ...
  const toggleModoEdicion = (dia, indexModulo) => {
  ...
  const renderCabeceraTabla = () => {
    ...
    const renderFilasTabla = () => {
      ...
      console.log(salaSeleccionada.dias);
      
      if (!salaSeleccionada || !salaSeleccionada.dias) {
        // Si no hay sala seleccionada o no tiene días, no renderizar nada o mostrar un mensaje
                  ...
                  <td key={`${dia}-${indexModulo}`}>
                    ...
                    {modoEdicion[`${dia}-${indexModulo}`] ? (
                      <div>
                        ...
                        <button onClick={() => toggleModoEdicion(dia, indexModulo)}>Guardar</button>
                      </div>
                    ) : (
                      <div>
                        ...
                        <span>{`${modulo.docente || 'N/A'}`}</span><br />
